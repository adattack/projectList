...
void MainWindow::tray()
{
    if(this->isVisible()){
        ...
        trayIcon->showMessage("Tray Program",
                              "应用程序被最小化到托盘。要展开应用程序窗口，请单击托盘中的应用程序图标",
                              icon, 2000);
    }
}
